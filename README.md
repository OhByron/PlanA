...
- ~~**Mobile Access (PWA)**~~ **SHIPPED** - Progressive web app with manifest, service worker (stale-while-revalidate caching), installable on mobile and desktop. SVG app icon, iOS/Android meta tags.
