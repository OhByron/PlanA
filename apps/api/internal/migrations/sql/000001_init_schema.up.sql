...
-- Creates all core tables for PlanA Phase 1.
-- PostgreSQL 16+ required; wal_level=logical must be set on the server (see docker-compose.yml).
...
CREATE TABLE design_attachments (
  ...
  figma_file_key         TEXT,
  figma_node_id          TEXT,
  figma_locked_version   TEXT,
  figma_current_version  TEXT,
